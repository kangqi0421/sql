...
-- reuse password hash
--
-- SELECT name, password, spare4 FROM sys.user$ WHERE name='QUARTZAS';
-- ALTER USER QUARTZAS IDENTIFIED BY VALUES 'S:333377748712A1D3E7708FC4F39E2A62AFF76F1766508FF96CE7DD34B6AD';