...
GRANT CSCONNECT, CS_APPL_ACCOUNTS TO "DBEIM";
GRANT CSCONNECT, CS_APPL_ACCOUNTS TO "DBMAIN";
GRANT CSCONNECT, CS_APPL_ACCOUNTS TO "MW";
GRANT CSCONNECT, CS_APPL_ACCOUNTS TO "MWAPP";
GRANT CSCONNECT, CS_APPL_ACCOUNTS TO "MWSTAT";

-- pouze DEV
-- CREATE USER "MW_TESTERS" identified by "abcd1234" profile PROF_APPL_UNLIMITED  default tablespace MDW_DATA_TS quota unlimited on MDW_DATA_TS;
-- GRANT CSCONNECT, CS_APPL_ACCOUNTS to MW_TESTERS;