...
BEGIN
  SELECT   sql_fulltext INTO v_sql_text  FROM v$sqlstats  WHERE sql_id='&sqlid' AND rownum  =1;
  SYS.DBMS_SQLDIAG_INTERNAL.I_CREATE_PATCH(
       SQL_TEXT => v_sql_text,
       hint_text => 'USE_HASH(@SEL$1 T4 T10)',
	   --'OPT_PARAM(''optimizer_index_caching'' 0) OPT_PARAM(''optimizer_index_cost_adj'' 100)
	   -- 
