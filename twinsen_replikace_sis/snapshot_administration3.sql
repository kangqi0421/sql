...
/* Creating public link TWINSEN.NATUR.CUNI.CZ at site ORIGIN.NATUR.CUNI.CZ... */

CREATE PUBLIC DATABASE LINK "TWINSEN.NATUR.CUNI.CZ" USING '(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=195.113.46.39)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=TWINSEN.NATUR.CUNI.CZ)))'

/* Creating user SNAPADMIN_ORIGIN_NATUR_CUNI_CZ at site TWINSEN.NATUR.CUNI.CZ... */

create user "SNAPADMIN_ORIGIN_NATUR_CUNI_CZ" identified by "jiricek"
...
CONNECT TO "SNAPADMIN_ORIGIN_NATUR_CUNI_CZ" IDENTIFIED BY "jiricek"
