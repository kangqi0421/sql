Rem
Rem $Header: dfltpass.sql 22-feb-2006.18:10:02 mfallon Exp $
Rem
Rem dfltpass.sql
Rem
...
Rem
Rem    NAME
Rem      dfltpass.sql - scan for default username / passwords 
Rem
Rem    DESCRIPTION
Rem      Scan the database schema accounts looking for default
Rem      username / password combinations. User list includes
Rem	 accounts from Database, iAS, OCS, EM, E-Business Suite,
Rem	 PeopleSoft and JD Edwards
Rem
Rem    NOTES
Rem      Needs read access to dba_users table 
Rem
Rem    MODIFIED   (MM/DD/YY)
Rem    dwiles      03/29/06 - Refreshed list of default accounts and
Rem                           passwords
Rem    dwiles      03/14/06 - Removed spaces incorrectly included in
Rem                           JD Edwards password hashes
Rem    dwiles      02/23/06 - Refreshed list of default accounts and
Rem                           passwords
Rem    mfallon     12/23/05 - SQL Script to check for default account / 
Rem                           passwords 
Rem    mfallon     12/23/05 - Created
Rem
...
TTITLE "Default Accounts With Default Passwords"
